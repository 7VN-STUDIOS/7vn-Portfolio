...
function renderHeader(active) {
  ...
  document.getElementById('site-header').innerHTML = `
    <div class="wrap">
      <a href="/" class="brand"><img src="/assets/logo.png" alt="7VN Studios"></a>
...
// Thumbnail/asset paths stored in the JSON data files (e.g. "assets/uploads/x.jpg")
// are relative to the SITE ROOT, not to whichever page happens to display them.
// Pages living in subfolders (like /work/ or /sagest/) need these resolved to an
// absolute root path, or the browser will look in the wrong folder.
